...
def merge_dates_and_towns_into_csv(dates_filename: str, towns_filename: str, csv_output_filename: str) -> None:
    ...
    Dates file contains names and dates.txt. Separated by colon.
    john:01.01.2001
    mary:06.03.2016
    ...
    The order of the lines should follow the order in dates.txt input file.
    Names which are missing in dates.txt input file, will follow the order
    in towns input file.
    ...
    :param dates_filename: Input file with names and dates.txt.
    :param towns_filename: Input file with names and towns.
    :param csv_output_filename: Output CSV-file with names, towns and dates.txt.
    :return: None
    """
