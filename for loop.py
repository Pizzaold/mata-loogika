...
def remove_vowels(original_string: str) -> str:
    ...
    """
    # Your code goes here
    vowels = ['a', 'e', 'i', 'o', 'u', "õ", "ä", "ö", "ü", 'A', 'E', 'I', 'O', 'U', "Õ", "Ä", "Ö", "Ü"]
    result = ""

    for temp in range(len(original_string)):
        if original_string[temp] not in vowels:
            result = result + original_string[temp]
    return result
